...
class GeneratorDataLoader(DataLoader):
    ...
    def __init__(self, config):
        ...
        self._image_generator = ImageDataGenerator(rescale=1./255, rotation_range=40, width_shift_range=0.2, height_shift_range=0.2, zoom_range=0.2, horizontal_flip=True, fill_mode="nearest")
    ...
    def __prepare_elements(self):
        ...
        for i in range(self._batch_size):
            index = random.randint(0, len(self._x_train))
